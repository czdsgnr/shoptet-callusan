# Shoptet úpravy – Callusan

Custom CSS + JS pro Shoptet e-shop **Callusan**, hostované na GitHubu a načítané
...
Sesterský setup k `shoptet-protvoreni` a `shoptet-deisirup`.
...
<script>
(function () {
  var base = 'https://czdsgnr.github.io/shoptet-callusan/';
  var t = '?t=' + Date.now();
...
```html
<link rel="stylesheet" href="https://czdsgnr.github.io/shoptet-callusan/shoptet.css?v=1">
<script src="https://czdsgnr.github.io/shoptet-callusan/shoptet.js?v=1" defer></script>
```
